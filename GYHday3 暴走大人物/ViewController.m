...
//  goyohol 暴走大人物
//
//  Created by goyohol on 16/2/17.
//  Copyright (c) 2016年 goyohol. All rights reserved.
//

#import "ViewController.h"

#define screenyouxi [UIScreen mainScreen].bounds
...
- (void)viewDidLoad {
    ...
    UIImageView * backgroungView = [[UIImageView alloc]initWithFrame:screenyouxi];
    //2.设置背景图片
    ...
    //1.创建按钮对象
    UIButton * buttonup = [[UIButton alloc]initWithFrame:CGRectMake((screenyouxi.size.width-100)/2.0f, screenyouxi.size.height-200, 100, 100)];
    UIButton * buttondown = [[UIButton alloc]initWithFrame:CGRectMake((screenyouxi.size.width-100)/2.0f, screenyouxi.size.height-100, 100, 100)];
    UIButton * buttonleft = [[UIButton alloc]initWithFrame:CGRectMake((screenyouxi.size.width-100)/2.0f-100, screenyouxi.size.height-150, 100, 100)];
    UIButton * buttonright = [[UIButton alloc]initWithFrame:CGRectMake((screenyouxi.size.width-100)/2.0f+100, screenyouxi.size.height-150, 100, 100)];
    //2.添加按钮对应图片
...
-(void)buttonOnClickUp      //上
{
    ...
    people.frame = CGRectMake(rect.origin.x, rect.origin.y-10, 80, 80);
    //上 ---   动画播放
    //a.设置播放图片组
...
-(void)buttonOnClickDown    //下
{
    ...
    CGRect rect = people.frame;
    if (rect.origin.y >= screenyouxi.size.height-80)
    {
        rect.origin.y = screenyouxi.size.height - 80;
    }
    people.frame = CGRectMake(rect.origin.x, rect.origin.y+10, 80, 80);
    //下 ---    动画播放
    //a.设置播放图片组
...
-(void)buttonOnClickleft    //左
{
    ...
    people.frame = CGRectMake(rect.origin.x-10, rect.origin.y, 80, 80);
    //左 ---    动画播放
    //a.设置播放图片组
    NSMutableArray * upAnimationImages = [[NSMutableArray alloc]init];
    for (int i = 1; i < 4; i++)
...
-(void)buttonOnClickright   //右
{
    ...
    CGRect rect = people.frame;
    if (rect.origin.x >= screenyouxi.size.width - 80)
    {
        rect.origin.x = screenyouxi.size.width - 80;
    }
    people.frame = CGRectMake(rect.origin.x+10, rect.origin.y, 80, 80);
    //右 ---    动画播放
    //a.设置播放图片组
